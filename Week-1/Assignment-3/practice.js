...
function toNumber(input) {
  const letterNumber = {a: 1, b: 2, c: 3, d: 4, e: 5}
  const result = []
  input.forEach(letter => result.push(letterNumber[letter]))
  return result
}
...
console.log(toNumber(input2)); // should print [5, 4, 3, 4, 5]// should print [5, 4, 3, 4, 5] 
